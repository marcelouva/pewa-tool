...
def timeout(seconds=900, error_message=os.strerror(errno.ETIME)):
    def decorator(func):
...
#la funcion corre y corta la corrida en 15 minutos. retorna un par con el tiempo y un booleano indicando si salio por timeouto o no
@timeout()
