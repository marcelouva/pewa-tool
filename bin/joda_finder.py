import os,sys,glob,generate_alt1_joda,generate_alt2,ap1
   ...
   if sys.argv[3]=='1':
	...
	if sys.argv[1] in casos_de_studio:
		...
		os.system(cade)
			...
			info=generate_alt1_joda.read_action(sys.argv[1])
			...
			if len(asercion)==0:
			    ...
			    generate_alt1_joda.fix_alt1_jodatime2(sys.argv[1],sys.argv[2],pin,tiempo_to,input_file)
