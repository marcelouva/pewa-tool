...
some 
   ...
   t : boolean |
   a_c00 in Xor[a.b00, a.b15] and
   b_c00 in Xor[b.b00, b.b15] and
   a_c01 in Xor[a.b01, a.b15] and
   b_c01 in Xor[b.b01, b.b15] and
   a_c02 in Xor[a.b02, a.b15] and
   b_c02 in Xor[b.b02, b.b15] and
   a_c03 in Xor[a.b03, a.b15] and
   b_c03 in Xor[b.b03, b.b15] and
   a_c04 in Xor[a.b04, a.b15] and
   b_c04 in Xor[b.b04, b.b15] and
   a_c05 in Xor[a.b05, a.b15] and
   b_c05 in Xor[b.b05, b.b15] and
   a_c06 in Xor[a.b06, a.b15] and
   b_c06 in Xor[b.b06, b.b15] and
   a_c07 in Xor[a.b07, a.b15] and
   b_c07 in Xor[b.b07, b.b15] and
   a_c08 in Xor[a.b08, a.b15] and
   b_c08 in Xor[b.b08, b.b15] and
   a_c09 in Xor[a.b09, a.b15] and
   b_c09 in Xor[b.b09, b.b15] and
   a_c10 in Xor[a.b10, a.b15] and
   b_c10 in Xor[b.b10, b.b15] and
   a_c11 in Xor[a.b11, a.b15] and
   b_c11 in Xor[b.b11, b.b15] and
   a_c12 in Xor[a.b12, a.b15] and
   b_c12 in Xor[b.b12, b.b15] and
   a_c13 in Xor[a.b13, a.b15] and
   b_c13 in Xor[b.b13, b.b15] and
   a_c14 in Xor[a.b14, a.b15] and
   b_c14 in Xor[b.b14, b.b15] and
   a_c15 in Xor[a.b15, a.b15] and
   b_c15 in Xor[b.b15, b.b15] and

   t in Xor[a.b15, b.b15] and

   s_0_0 in AdderSum  [And[a_c00,b.b15], And[a.b15, b_c00], And[a.b15, b.b15]] and
   c_0_0 in AdderCarry[And[a_c00,b.b15], And[a.b15, b_c00], And[a.b15, b.b15]] and

   s_0_1 in AdderSum  [s_0_0, And[a_c00, b_c00], false] and
   c_0_1 in AdderCarry[s_0_0, And[a_c00, b_c00], false] and

   s_1_0 in AdderSum  [And[a_c01,b.b15], And[a.b15, b_c01], false] and
   c_1_0 in AdderCarry[And[a_c01,b.b15], And[a.b15, b_c01], false] and
   ...
   s_2_0 in AdderSum  [And[a_c02,b.b15], And[a.b15, b_c02], false] and
   c_2_0 in AdderCarry[And[a_c02,b.b15], And[a.b15, b_c02], false] and
   ...
   s_3_0 in AdderSum  [And[a_c03,b.b15], And[a.b15, b_c03], false] and
   c_3_0 in AdderCarry[And[a_c03,b.b15], And[a.b15, b_c03], false] and
   ...
   s_4_0 in AdderSum  [And[a_c04,b.b15], And[a.b15, b_c04], false] and
   c_4_0 in AdderCarry[And[a_c04,b.b15], And[a.b15, b_c04], false] and
   ...
   s_5_0 in AdderSum  [And[a_c05,b.b15], And[a.b15, b_c05], false] and
   c_5_0 in AdderCarry[And[a_c05,b.b15], And[a.b15, b_c05], false] and
   ...
   s_6_0 in AdderSum  [And[a_c06,b.b15], And[a.b15, b_c06], false] and
   c_6_0 in AdderCarry[And[a_c06,b.b15], And[a.b15, b_c06], false] and
   ...
   s_7_0 in AdderSum  [And[a_c07,b.b15], And[a.b15, b_c07], false] and
   c_7_0 in AdderCarry[And[a_c07,b.b15], And[a.b15, b_c07], false] and
   ...
   s_8_0 in AdderSum  [And[a_c08,b.b15], And[a.b15, b_c08], false] and
   c_8_0 in AdderCarry[And[a_c08,b.b15], And[a.b15, b_c08], false] and
   ...
   s_9_0 in AdderSum  [And[a_c09,b.b15], And[a.b15, b_c09], false] and
   c_9_0 in AdderCarry[And[a_c09,b.b15], And[a.b15, b_c09], false] and
   ...
   s_10_0 in AdderSum  [And[a_c10,b.b15], And[a.b15, b_c10], false] and
   c_10_0 in AdderCarry[And[a_c10,b.b15], And[a.b15, b_c10], false] and
   ...
   s_11_0 in AdderSum  [And[a_c11,b.b15], And[a.b15, b_c11], false] and
   c_11_0 in AdderCarry[And[a_c11,b.b15], And[a.b15, b_c11], false] and
   ...
   s_12_0 in AdderSum  [And[a_c12,b.b15], And[a.b15, b_c12], false] and
   c_12_0 in AdderCarry[And[a_c12,b.b15], And[a.b15, b_c12], false] and
   ...
   s_13_0 in AdderSum  [And[a_c13,b.b15], And[a.b15, b_c13], false] and
   c_13_0 in AdderCarry[And[a_c13,b.b15], And[a.b15, b_c13], false] and
   ...
   s_14_0 in AdderSum  [And[a_c14,b.b15], And[a.b15, b_c14], false] and
   c_14_0 in AdderCarry[And[a_c14,b.b15], And[a.b15, b_c14], false] and
   ...
   s_15_0 in AdderSum  [And[a_c15,b.b15], And[a.b15, b_c15], false] and
   c_15_0 in AdderCarry[And[a_c15,b.b15], And[a.b15, b_c15], false] and
   ...
   s_15_0 in false and
   s_15_1 in AdderSum  [s_31_0, And[a_c30, b_c01], c_30_0] and
   c_15_1 in AdderCarry[s_31_0, And[a_c30, b_c01], c_30_0] and
   s_15_2 in AdderSum  [s_31_1, And[a_c29, b_c02], c_30_1] and
   c_15_2 in AdderCarry[s_31_1, And[a_c29, b_c02], c_30_1] and
   s_15_3 in AdderSum  [s_31_2, And[a_c28, b_c03], c_30_2] and
   c_15_3 in AdderCarry[s_31_2, And[a_c28, b_c03], c_30_2] and
   s_15_4 in AdderSum  [s_31_3, And[a_c27, b_c04], c_30_3] and
   c_15_4 in AdderCarry[s_31_3, And[a_c27, b_c04], c_30_3] and
   s_15_5 in AdderSum  [s_31_4, And[a_c26, b_c05], c_30_4] and
   c_15_5 in AdderCarry[s_31_4, And[a_c26, b_c05], c_30_4] and
   s_15_6 in AdderSum  [s_31_5, And[a_c25, b_c06], c_30_5] and
   c_15_6 in AdderCarry[s_31_5, And[a_c25, b_c06], c_30_5] and
   s_15_7 in AdderSum  [s_31_6, And[a_c24, b_c07], c_30_6] and
   c_15_7 in AdderCarry[s_31_6, And[a_c24, b_c07], c_30_6] and
   s_15_8 in AdderSum  [s_31_7, And[a_c23, b_c08], c_30_7] and
   c_15_8 in AdderCarry[s_31_7, And[a_c23, b_c08], c_30_7] and
   s_15_9 in AdderSum  [s_31_8, And[a_c22, b_c09], c_30_8] and
   c_15_9 in AdderCarry[s_31_8, And[a_c22, b_c09], c_30_8] and
   s_15_10 in AdderSum  [s_31_9, And[a_c21, b_c10], c_30_9] and
   c_15_10 in AdderCarry[s_31_9, And[a_c21, b_c10], c_30_9] and
   s_15_11 in AdderSum  [s_31_10, And[a_c20, b_c11], c_30_10] and
   c_15_11 in AdderCarry[s_31_10, And[a_c20, b_c11], c_30_10] and
   s_15_12 in AdderSum  [s_31_11, And[a_c19, b_c12], c_30_11] and
   c_15_12 in AdderCarry[s_31_11, And[a_c19, b_c12], c_30_11] and
   s_15_13 in AdderSum  [s_31_12, And[a_c18, b_c13], c_30_12] and
   c_15_13 in AdderCarry[s_31_12, And[a_c18, b_c13], c_30_12] and
   s_15_14 in AdderSum  [s_31_13, And[a_c17, b_c14], c_30_13] and
   c_15_14 in AdderCarry[s_31_13, And[a_c17, b_c14], c_30_13] and
   s_15_15 in AdderSum  [s_31_14, And[a_c16, b_c15], c_30_14] and
   c_15_15 in AdderCarry[s_31_14, And[a_c16, b_c15], c_30_14] and
   s_15_16 in AdderSum  [s_31_15, And[a_c15, b_c16], c_30_15] and
   c_15_16 in AdderCarry[s_31_15, And[a_c15, b_c16], c_30_15] and

   s_15_16 in s_15_15 and
   (
      t in false => (
         ...
         result.b15 in Xor[Not[s_15_16], And[Not[s_14_15], Xor[Not[s_14_15], result.b14]]]  
      )
   )
   }
...
pred pred_java_primitive_integer_value_gt_zero[a: JavaPrimitiveIntegerValue] {
   a.b15 in false and not pred_java_primitive_integer_value_eq_zero[a] 
}
...
pred pred_java_primitive_integer_value_div_rem[a: JavaPrimitiveIntegerValue, 
  ...
  and 
  (rem.b15 in true implies 
(rem.b14 in true or rem.b13 in true or rem.b12 in true
 or rem.b11 in true or rem.b10 in true or rem.b09 in true or rem.b08 in true or rem.b07 in true or rem.b06 in true or
 rem.b05 in true or rem.b04 in true or rem.b03 in true or rem.b02 in true or rem.b01 in true or rem.b00 in true)) 
  and 
...
one sig d0_32 extends JavaPrimitiveIntegerValue {}
one sig d1_32 extends JavaPrimitiveIntegerValue {}
one sig d24_32 extends JavaPrimitiveIntegerValue {}
one sig d60_32 extends JavaPrimitiveIntegerValue {}

one sig d1000_32 extends JavaPrimitiveIntegerValue {}

fact {d0_32.b00=false
          d0_32.b01=false
          d0_32.b02=false
          d0_32.b03=false
          d0_32.b04=false
