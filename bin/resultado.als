...
fact {
  (
    (
      ...
      or 
      (
        Lista_last_indexOf[QF.intJ_1_0,
                          QF.thisType_1_0,
                          QF.thisType_1_1,
                          QF.return_intJ_1_1]
        and 
  ...
  or 
  (
    Lista_remove_first[QF.thisType_1_0,
                      QF.thisType_1_1,
                      QF.return_intJ_1_1]
    and 
    (
      QF.ac_1=Lista_remove_first)
    and 
    verify_null[QF.return_intJ_1_1,
               QF.valid_intJ_2]
    and 
