...
N0+N1+N2+N3+N4+N5+N6+N7+N8+N9+N10+N11+N12+N13+N14+N15+N16+N17+N18+N19+N20+N21+N22 = ff1.univ + bf1.univ 
...
one sig N0,N1,N2,N3,N4,N5,N6,N7,N8,N9,N10,N11,N12,N13,N14,N15,N16,N17,N18,N19,N20,N21,N22 extends SListInt32Node {}
...
// myseq definitions
fun int32_max[es: set (i320+i321+i322+i323+i324+i325+i326+i327+i328+i329+i3210+i3211+i3212+i3213+i3214+i3215+i3216+i3217+i3218+i3219+i3220+i3221+i3222)] : lone (i320+i321+i322+i323+i324+i325+i326+i327+i328+i329+i3210+i3211+i3212+i3213+i3214+i3215+i3216+i3217+i3218+i3219+i3220+i3221+i3222) {
 es - es.(
   i321->(i320)
   +
   i322->(i320+i321)
...
fun int32_prevs[e: i320+i321+i322+i323+i324+i325+i326+i327+i328+i329+i3210+i3211+i3212+i3213+i3214+i3215+i3216+i3217+i3218+i3219+i3220+i3221+i3222] :set (i320+i321+i322+i323+i324+i325+i326+i327+i328+i329+i3210+i3211+i3212+i3213+i3214+i3215+i3216+i3217+i3218+i3219+i3220+i3221+i3222) {
 e.(
   i321->(i320)
   +
   i322->(i320+i321)
...
run CanSatisfyInvariant for 0 but exactly 1 SListInt32MySeq, exactly 23 SListInt32Node, 1 int, exactly 24 JavaPrimitiveIntegerValue
...
QF.index_0 in N0->i320 + N1->i321 + N2->i322 + N3->i323 + N4->i324 + N5->i325 + N6->i326 + N7->i327 + N8->i328 + N9->i329 + N10->i3210 + N11->i3211 + N12->i3212 + N13->i3213 + N14->i3214 + N15->i3215 + N16->i3216 + N17->i3217 + N18->i3218 + N19->i3219 + N20->i3220 + N21->i3221 + N22->i3222

//Bound for field QF.fnext_0: 
QF.fnext_0 in N0->null + N0->N1 + N1->null + N1->N2 + N2->null + N2->N3 + N3->null + N3->N4 + N4->null + N4->N5 + N5->null + N5->N6 + N6->null + N6->N7 + N7->null + N7->N8 + N8->null + N8->N9 + N9->null + N9->N10 + N10->null + N10->N11 + N11->null + N11->N12 + N12->null + N12->N13 + N13->null + N13->N14 + N14->null + N14->N15 + N15->null + N15->N16 + N16->null + N16->N17 + N17->null + N17->N18 + N18->null + N18->N19 + N19->null + N19->N20 + N20->null + N20->N21 + N21->null + N21->N22 + N22->null
