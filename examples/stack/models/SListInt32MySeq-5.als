...
one sig N0,N1,N2,N3,N4 extends SListInt32Node {}
...
fact {
	(QF.index_0) in N0->i320+N0->i321+N0->i322+N0->i323+N0->i324+N0->null+N1->i320+N1->i321+N1->i322+N1->i323+N1->i324+N1->null+N2->i320+N2->i321+N2->i322+N2->i323+N2->i324+N2->null+N3->i320+N3->i321+N3->i322+N3->i323+N3->i324+N3->null+N4->i320+N4->i321+N4->i322+N4->i323+N4->i324+N4->null
}


fact {
	(QF.size_0) in SListInt32MySeq->i320+SListInt32MySeq->i321+SListInt32MySeq->i322+SListInt32MySeq->i323+SListInt32MySeq->i324+SListInt32MySeq->i325
}
...
run CanSatisfyInvariant for 0 but exactly 1 SListInt32MySeq, exactly 5 SListInt32Node, 1 int, exactly 6 JavaPrimitiveIntegerValue
...
QF.index_0 in N0->i320 + N1->i321 + N2->i322 + N3->i323 + N4->i324

//Bound for field QF.fnext_0: 
QF.fnext_0 in N0->null + N0->N1 + N1->null + N1->N2 + N2->null + N2->N3 + N3->null + N3->N4 + N4->null
