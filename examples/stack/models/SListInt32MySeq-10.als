...
N0+N1+N2+N3+N4+N5+N6+N7+N8+N9 = ff1.univ + bf1.univ 
...
fun FReach[] :set (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9) {
    (QF.thiz_0).(QF.head_0).*(QF.fnext_0)-null
}

one sig N0,N1,N2,N3,N4,N5,N6,N7,N8,N9 extends SListInt32Node {}




fact { QF.fnext_0 in N0->N1+N0->N2+N0->N3+N0->N4+N0->N5+N0->N6+N0->N7+N0->N8+N0->N9+N0->null+N1->N2+N1->N3+N1->N4+N1->N5+N1->N6+N1->N7+N1->N8+N1->N9+N1->null+N2->N3+N2->N4+N2->N5+N2->N6+N2->N7+N2->N8+N2->N9+N2->null+N3->N4+N3->N5+N3->N6+N3->N7+N3->N8+N3->N9+N3->null+N4->N5+N4->N6+N4->N7+N4->N8+N4->N9+N4->null+N5->N6+N5->N7+N5->N8+N5->N9+N5->null+N6->N7+N6->N8+N6->N9+N6->null+N7->N8+N7->N9+N7->null+N8->N9+N8->null+N9->null }
...
fact {
	(QF.index_0) in N0->i320+N0->i321+N0->i322+N0->i323+N0->i324+N0->i325+N0->i326+N0->i327+N0->i328+N0->i329+N0->null+N1->i320+N1->i321+N1->i322+N1->i323+N1->i324+N1->i325+N1->i326+N1->i327+N1->i328+N1->i329+N1->null+N2->i320+N2->i321+N2->i322+N2->i323+N2->i324+N2->i325+N2->i326+N2->i327+N2->i328+N2->i329+N2->null+N3->i320+N3->i321+N3->i322+N3->i323+N3->i324+N3->i325+N3->i326+N3->i327+N3->i328+N3->i329+N3->null+N4->i320+N4->i321+N4->i322+N4->i323+N4->i324+N4->i325+N4->i326+N4->i327+N4->i328+N4->i329+N4->null+N5->i320+N5->i321+N5->i322+N5->i323+N5->i324+N5->i325+N5->i326+N5->i327+N5->i328+N5->i329+N5->null+N6->i320+N6->i321+N6->i322+N6->i323+N6->i324+N6->i325+N6->i326+N6->i327+N6->i328+N6->i329+N6->null+N7->i320+N7->i321+N7->i322+N7->i323+N7->i324+N7->i325+N7->i326+N7->i327+N7->i328+N7->i329+N7->null+N8->i320+N8->i321+N8->i322+N8->i323+N8->i324+N8->i325+N8->i326+N8->i327+N8->i328+N8->i329+N8->null+N9->i320+N9->i321+N9->i322+N9->i323+N9->i324+N9->i325+N9->i326+N9->i327+N9->i328+N9->i329+N9->null
}


fact {
	(QF.size_0) in SListInt32MySeq->i320+SListInt32MySeq->i321+SListInt32MySeq->i322+SListInt32MySeq->i323+SListInt32MySeq->i324+SListInt32MySeq->i325+SListInt32MySeq->i326+SListInt32MySeq->i327+SListInt32MySeq->i328+SListInt32MySeq->i329+SListInt32MySeq->i3210
}
...
// myseq definitions
fun int32_max[es: set (i320+i321+i322+i323+i324+i325+i326+i327+i328+i329)] : lone (i320+i321+i322+i323+i324+i325+i326+i327+i328+i329) {
 es - es.(
   i321->(i320)
   +
   i322->(i320+i321)
...
fun int32_prevs[e: i320+i321+i322+i323+i324+i325+i326+i327+i328+i329] :set (i320+i321+i322+i323+i324+i325+i326+i327+i328+i329) {
 e.(
   i321->(i320)
   +
   i322->(i320+i321)
...
fun node_max[es: set (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9)] : lone (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9) {
 es - es.(
   N1->(N0)
   +
   N2->(N0+N1)
...
run CanSatisfyInvariant for 0 but exactly 1 SListInt32MySeq, exactly 10 SListInt32Node, 1 int, exactly 18  JavaPrimitiveIntegerValue

fun node_next[]: (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9) -> lone (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9) {
 N0->N1
 +
 N1->N2
 +
...
fun node_prevs[e: N0+N1+N2+N3+N4+N5+N6+N7+N8+N9] :set (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9) {
 e.(
   N1->(N0)
   +
   N2->(N0+N1)
...
fun node_rprevs[e: N0+N1+N2+N3+N4+N5+N6+N7+N8+N9] :set (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9) {
 e.(
   N0->(N0)
   +
   N1->(N0+N1)
...
fun node_relprevs[] : (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9) -> set (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9) {
   N0->(N0)
   +
   N1->(N0+N1)
   +
...
fun node_min[es: set (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9)] : lone (N0+N1+N2+N3+N4+N5+N6+N7+N8+N9) {
 es - es.(
...
QF.index_0 in N0->i320 + N1->i321 + N2->i322 + N3->i323 + N4->i324 + N5->i325 + N6->i326 + N7->i327 + N8->i328 + N9->i329

//Bound for field QF.fnext_0: 
QF.fnext_0 in N0->null + N0->N1 + N1->null + N1->N2 + N2->null + N2->N3 + N3->null + N3->N4 + N4->null + N4->N5 + N5->null + N5->N6 + N6->null + N6->N7 + N7->null + N7->N8 + N8->null + N8->N9 + N9->null
