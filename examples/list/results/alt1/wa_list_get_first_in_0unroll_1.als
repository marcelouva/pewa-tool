...
pred pred_not[p_0:JavaPrimitiveIntegerValue->lone JavaPrimitiveIntegerValue,p_1:JavaPrimitiveIntegerValue->lone JavaPrimitiveIntegerValue,p_2:JavaPrimitiveIntegerValue,b:boolean]{ not(postcondition_Lista_get_first[p_0,p_1,p_2] and b=true)}
...
fact {
  precondition_Lista_get_first[QF.thisType_1_0]
}
