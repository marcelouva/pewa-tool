...
fact {
	(QF.size_0) in SListInt32MySeq->i320+SListInt32MySeq->i321+SListInt32MySeq->i322+SListInt32MySeq->i323+SListInt32MySeq->i324+SListInt32MySeq->i325+SListInt32MySeq->i326+SListInt32MySeq->i327+SListInt32MySeq->i328+SListInt32MySeq->i329+SListInt32MySeq->i3210+SListInt32MySeq->i3211
}
...
// myseq definitions
fun int32_max[es: set (i320+i321+i322+i323+i324+i325+i326+i327+i328+i329+i3210)] : lone (i320+i321+i322+i323+i324+i325+i326+i327+i328+i329+i3210) {
 es - es.(
   i321->(i320)
   +
   i322->(i320+i321)
...
fun int32_prevs[e: i320+i321+i322+i323+i324+i325+i326+i327+i328+i329+i3210] :set (i320+i321+i322+i323+i324+i325+i326+i327+i328+i329+i3210) {
 e.(
   i321->(i320)
   +
   i322->(i320+i321)
...
run CanSatisfyInvariant for 0 but exactly 1 SListInt32MySeq, exactly 11 SListInt32Node, 1 int, exactly 21  JavaPrimitiveIntegerValue
...
QF.index_0 in N0->i320 + N1->i321 + N2->i322 + N3->i323 + N4->i324 + N5->i325 + N6->i326 + N7->i327 + N8->i328 + N9->i329 + N10->i3210

//Bound for field QF.fnext_0: 
QF.fnext_0 in N0->null + N0->N1 + N1->null + N1->N2 + N2->null + N2->N3 + N3->null + N3->N4 + N4->null + N4->N5 + N5->null + N5->N6 + N6->null + N6->N7 + N7->null + N7->N8 + N8->null + N8->N9 + N9->null + N9->N10 + N10->null
