...
one sig N0,N1,N2,N3,N4,N5,N6,N7,N8 extends SListInt32Node {}




fact { QF.fnext_0 in N0->N1+N0->N2+N0->N3+N0->N4+N0->N5+N0->N6+N0->N7+N0->N8+N0->null+N1->N2+N1->N3+N1->N4+N1->N5+N1->N6+N1->N7+N1->N8+N1->null+N2->N3+N2->N4+N2->N5+N2->N6+N2->N7+N2->N8+N2->null+N3->N4+N3->N5+N3->N6+N3->N7+N3->N8+N3->null+N4->N5+N4->N6+N4->N7+N4->N8+N4->null+N5->N6+N5->N7+N5->N8+N5->null+N6->N7+N6->N8+N6->null+N7->N8+N7->null+N8->null }
fact { QF.bnext_0 in N0->N0+N1->N0+N1->N1+N2->N0+N2->N1+N2->N2+N3->N0+N3->N1+N3->N2+N3->N3+N4->N0+N4->N1+N4->N2+N4->N3+N4->N4+N5->N0+N5->N1+N5->N2+N5->N3+N5->N4+N5->N5+N6->N0+N6->N1+N6->N2+N6->N3+N6->N4+N6->N5+N6->N6+N7->N0+N7->N1+N7->N2+N7->N3+N7->N4+N7->N5+N7->N6+N7->N7+N8->N0+N8->N1+N8->N2+N8->N3+N8->N4+N8->N5+N8->N6+N8->N7+N8->N8 }
...
fact {
	(QF.size_0) in SListInt32MySeq->i320+SListInt32MySeq->i321+SListInt32MySeq->i322+SListInt32MySeq->i323+SListInt32MySeq->i324+SListInt32MySeq->i325+SListInt32MySeq->i326+SListInt32MySeq->i327+SListInt32MySeq->i328+SListInt32MySeq->i329
}
...
// myseq definitions
fun int32_max[es: set (i320+i321+i322+i323+i324+i325+i326+i327+i328)] : lone (i320+i321+i322+i323+i324+i325+i326+i327+i328) {
 es - es.(
   i321->(i320)
   +
   i322->(i320+i321)
...
fun int32_prevs[e: i320+i321+i322+i323+i324+i325+i326+i327+i328] :set (i320+i321+i322+i323+i324+i325+i326+i327+i328) {
 e.(
   i321->(i320)
   +
   i322->(i320+i321)
...
run CanSatisfyInvariant for 0 but exactly 1 SListInt32MySeq, exactly 9 SListInt32Node, 1 int, exactly 17  JavaPrimitiveIntegerValue
...
QF.index_0 in N0->i320 + N1->i321 + N2->i322 + N3->i323 + N4->i324 + N5->i325 + N6->i326 + N7->i327 + N8->i328

//Bound for field QF.fnext_0: 
QF.fnext_0 in N0->null + N0->N1 + N1->null + N1->N2 + N2->null + N2->N3 + N3->null + N3->N4 + N4->null + N4->N5 + N5->null + N5->N6 + N6->null + N6->N7 + N7->null + N7->N8 + N8->null
